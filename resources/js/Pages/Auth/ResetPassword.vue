    ...
    <div class="flex-grow flex flex-col justify-center py-12 md:py-24">
      <div class="relative z-10 w-full max-w-md mx-auto px-6">
        ...
        <div class="text-center mb-10">
          ...
          <p class="text-slate-500 font-medium mt-4">Set your fresh credentials below.</p>
        </div>
        ...
        <p class="text-center text-sm font-medium text-slate-500 mb-12">
          Need help?
          <a href="mailto:support@metapilot.ai" class="text-primary hover:text-primary-hover font-bold underline-offset-4 hover:underline transition-all">Support Center</a>
        </p>
      </div>
    </div>
