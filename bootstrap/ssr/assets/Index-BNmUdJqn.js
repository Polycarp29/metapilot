                          ...
                          createVNode("div", { class: "flex-1 flex overflow-hidden relative" }, [
                            createVNode("div", { class: "flex-1 p-12 overflow-y-auto bg-white custom-scrollbar" }, [
                              createVNode("div", { class: "max-w-4xl mx-auto" }, [
                                ...
                                createVNode("div", { class: "sticky top-0 z-10 flex items-center gap-1 p-2 mb-6 bg-white/80 backdrop-blur-md border border-slate-200 rounded-2xl shadow-sm self-start" }, [
                                  createVNode("button", {
                                    onClick: ($event) => format("bold"),
                                    class: "px-3 py-2 hover:bg-slate-100 rounded-lg text-slate-600 transition-all font-black text-xs",
                                    title: "Bold"
                                  }, "B", 8, ["onClick"]),
                                  createVNode("button", {
                                    onClick: ($event) => format("italic"),
                                    class: "px-3 py-2 hover:bg-slate-100 rounded-lg text-slate-600 italic transition-all font-serif text-xs",
                                    title: "Italic"
                                  }, "I", 8, ["onClick"]),
                                  createVNode("button", {
                                    onClick: ($event) => format("underline"),
                                    class: "px-3 py-2 hover:bg-slate-100 rounded-lg text-slate-600 underline transition-all font-serif text-xs",
                                    title: "Underline"
                                  }, "U", 8, ["onClick"]),
                                  createVNode("div", { class: "w-px h-6 bg-slate-200 mx-1" }),
                                  createVNode("button", {
                                    onClick: ($event) => format("formatBlock", "h2"),
                                    class: "px-2 py-1 hover:bg-slate-100 rounded-lg text-[10px] font-black text-slate-600 transition-all",
                                    title: "Heading 2"
                                  }, "H2", 8, ["onClick"]),
                                  createVNode("button", {
                                  ...
                                  createVNode("button", {
                                    ...
                                    class: "p-2 hover:bg-slate-100 rounded-lg text-slate-600 transition-all",
                                    title: "Bullet List"
                                  }, [
                                    (openBlock(), createBlock("svg", {
                                      class: "w-4 h-4",
