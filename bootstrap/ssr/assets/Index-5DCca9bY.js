import { ref, computed, onMounted, mergeProps, withCtx, unref, createTextVNode, openBlock, createBlock, createVNode, Fragment, renderList, toDisplayString, withModifiers, withDirectives, vModelText, createCommentVNode, vModelSelect, Transition, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (activeTab.value === "security") {
              _push2(`<div class="space-y-6 animate-fade-in"${_scopeId}><div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-premium p-8"${_scopeId}><div class="flex items-center gap-4 mb-8"${_scopeId}><div class="w-12 h-12 bg-rose-100 rounded-2xl flex items-center justify-center text-rose-600"${_scopeId}><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"${_scopeId}></path></svg></div><div${_scopeId}><h2 class="text-xl font-bold text-slate-900"${_scopeId}>Security &amp; Infrastructure</h2><p class="text-sm text-slate-500"${_scopeId}>Manage your data lifecycle, backups, and bot protection settings.</p></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-8"${_scopeId}><div class="p-8 rounded-3xl border border-slate-100 bg-slate-50/50 flex flex-col justify-between"${_scopeId}><div${_scopeId}><div class="flex items-center gap-3 mb-4"${_scopeId}><div class="w-10 h-10 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center"${_scopeId}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4"${_scopeId}></path></svg></div><h3 class="font-bold text-slate-900"${_scopeId}>Database Archiving</h3></div><p class="text-sm text-slate-500 leading-relaxed mb-6"${_scopeId}> Historical data older than 90 days is automatically moved to a dedicated storage database every Sunday at 00:30 AM to maintain peak application performance. </p></div>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("organization.archive"),
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Open Archive Manager <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      createTextVNode(" Open Archive Manager "),
              ...
              _push2(`</div><div class="p-8 rounded-3xl border border-slate-100 bg-slate-50/50 flex flex-col justify-between"${_scopeId}><div${_scopeId}><div class="flex items-center gap-3 mb-4"${_scopeId}><div class="w-10 h-10 rounded-xl bg-rose-100 text-rose-600 flex items-center justify-center"${_scopeId}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 00-2 2z"${_scopeId}></path></svg></div><h3 class="font-bold text-slate-900"${_scopeId}>Bot Firewall</h3></div><p class="text-sm text-slate-500 leading-relaxed mb-6"${_scopeId}> Advanced multi-signal firewall automatically detects and blocks malicious automated scanners and scrapers based on request scoring. </p><div class="flex items-center gap-2 mb-6"${_scopeId}><span class="w-2 h-2 rounded-full bg-green-500 animate-pulse"${_scopeId}></span><span class="text-xs font-bold text-slate-400 uppercase tracking-widest"${_scopeId}>Protection Active</span></div></div><div class="p-3 bg-white border border-slate-100 rounded-xl text-center"${_scopeId}><p class="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]"${_scopeId}>Daily Security Log Integrated</p></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "max-w-5xl mx-auto space-y-8" }, [
                      ...
                      createVNode("div", { class: "p-8 bg-blue-50/30 rounded-[2rem] border border-blue-100/50" }, [
                        createVNode("div", { class: "flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8" }, [
                          ...
                          createVNode("a", {
                            ...
                            createVNode("i", { class: "fab fa-google text-[#4285F4]" }),
                ...
                activeTab.value === "security" ? (openBlock(), createBlock("div", {
                  key: 6,
                  class: "space-y-6 animate-fade-in"
                }, [
                  createVNode("div", { class: "bg-white rounded-[2.5rem] border border-slate-100 shadow-premium p-8" }, [
                    createVNode("div", { class: "flex items-center gap-4 mb-8" }, [
                      createVNode("div", { class: "w-12 h-12 bg-rose-100 rounded-2xl flex items-center justify-center text-rose-600" }, [
                        (openBlock(), createBlock("svg", {
                          class: "w-6 h-6",
                          fill: "none",
                          stroke: "currentColor",
                      ...
                      createVNode("div", null, [
                        createVNode("h2", { class: "text-xl font-bold text-slate-900" }, "Security & Infrastructure"),
                        createVNode("p", { class: "text-sm text-slate-500" }, "Manage your data lifecycle, backups, and bot protection settings.")
                      ])
                    ]),
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-8" }, [
                      createVNode("div", { class: "p-8 rounded-3xl border border-slate-100 bg-slate-50/50 flex flex-col justify-between" }, [
                        createVNode("div", null, [
                          createVNode("div", { class: "flex items-center gap-3 mb-4" }, [
                            createVNode("div", { class: "w-10 h-10 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center" }, [
                              (openBlock(), createBlock("svg", {
                                class: "w-5 h-5",
                                fill: "none",
                                stroke: "currentColor",
                            ...
                            createVNode("h3", { class: "font-bold text-slate-900" }, "Database Archiving")
                          ]),
                          createVNode("p", { class: "text-sm text-slate-500 leading-relaxed mb-6" }, " Historical data older than 90 days is automatically moved to a dedicated storage database every Sunday at 00:30 AM to maintain peak application performance. ")
                        ]),
                      ...
                      createVNode("div", { class: "p-8 rounded-3xl border border-slate-100 bg-slate-50/50 flex flex-col justify-between" }, [
                        createVNode("div", null, [
                          createVNode("div", { class: "flex items-center gap-3 mb-4" }, [
                            createVNode("div", { class: "w-10 h-10 rounded-xl bg-rose-100 text-rose-600 flex items-center justify-center" }, [
                              (openBlock(), createBlock("svg", {
                                class: "w-5 h-5",
                                fill: "none",
                                stroke: "currentColor",
                            ...
                            createVNode("h3", { class: "font-bold text-slate-900" }, "Bot Firewall")
                          ]),
                          createVNode("p", { class: "text-sm text-slate-500 leading-relaxed mb-6" }, " Advanced multi-signal firewall automatically detects and blocks malicious automated scanners and scrapers based on request scoring. "),
                          createVNode("div", { class: "flex items-center gap-2 mb-6" }, [
                            createVNode("span", { class: "w-2 h-2 rounded-full bg-green-500 animate-pulse" }),
                            createVNode("span", { class: "text-xs font-bold text-slate-400 uppercase tracking-widest" }, "Protection Active")
                          ])
                        ]),
                        createVNode("div", { class: "p-3 bg-white border border-slate-100 rounded-xl text-center" }, [
                          createVNode("p", { class: "text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]" }, "Daily Security Log Integrated")
                        ])
                      ])
                    ])
                  ])
