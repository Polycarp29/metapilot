...
import { _ as _sfc_main$3 } from "./BrandLogo-wIKyrnft.js";
const _sfc_main$2 = {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex items-center space-x-4"><div class="h-8 w-px bg-slate-200 mx-2 hidden sm:block"></div>`);
