 ...
 *
 * NOTE: This static file lives at public/cdn/ads-tracker.js so nginx can
 * serve it directly without a PHP round-trip. The server URL is resolved
 * at runtime from the script tag's src attribute (see serverBase below).
 */
(function () {
    'use strict';
    ...
    // Resolve server base from the script's own src URL.
    // e.g. src="https://metapilot.org/cdn/ads-tracker.js" → "https://metapilot.org"
    const serverBase = (script && script.src ? script.src.split('/cdn/')[0] : window.location.origin);
